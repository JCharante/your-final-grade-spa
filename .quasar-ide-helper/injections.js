...
Vue.prototype.$q = {
  ...
  cookies : {
     ...
     * @param {{expires : Number|String, path : String, domain : String, sameSite : String, httpOnly : Boolean, secure : Boolean, other : String}} [options] Cookie options
     * @returns  
     */
  ...
  notify : {
     ...
     * @param {{color : String, textColor : String, message : String, html : Boolean, icon : String, avatar : String, position : 'top-left'|'top-right'|'bottom-left'|'bottom-right'|'top'|'bottom'|'left'|'right'|'center', classes : String, timeout : Number, actions : Array, onDismiss : Function, closeBtn : String, multiLine : Boolean, ignoreDefaults : Boolean}|String} opts For syntax, check quasar.conf options parameters
